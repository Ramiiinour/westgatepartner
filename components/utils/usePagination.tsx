...
const usePagination = (value: any) => {
    ...
    const [paginationData, setPaginationData] = useState<any>({
        ...
        ProductsPerPage: 6,
        TotalPages: function () {
            return Math.ceil(this.Totalpropducts / this.ProductsPerPage)
        },
        TotalPagesArray: function () {
            return [...Array.from(this.TotalPages()).keys()]
        },
    })
    useEffect(() => {
        if (value) {
