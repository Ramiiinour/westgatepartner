...
// userchart data
export const userseries:any = [44, 55, 41, 17]

export const Useroptions:any = {
...
export const properylistdata:any = [
    {
        id: 1,
...
export const FollowingData:any = [
    {
        id: 1,
